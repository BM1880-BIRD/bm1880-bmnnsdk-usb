...
class LeakyReluOp : public CustomizedOp {
 public:
  explicit LeakyReluOp(FrontendContext *ctx) : CustomizedOp(ctx) {}
  LeakyReluOp(FrontendContext *ctx, const ONNX_NAMESPACE::Node *pOnnxNode) : CustomizedOp(ctx, pOnnxNode) {}
