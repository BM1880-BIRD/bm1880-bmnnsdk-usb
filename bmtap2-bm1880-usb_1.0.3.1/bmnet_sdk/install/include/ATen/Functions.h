...
static inline Tensor & _th_clamp_out(Tensor & result, const Tensor & self, Scalar min, Scalar max) {
    return infer_type(self)._th_clamp_out(result, self, min, max);
}
static inline Tensor _th_clamp(const Tensor & self, Scalar min, Scalar max) {
    return infer_type(self)._th_clamp(self, min, max);
}
static inline Tensor & _th_clamp_min_out(Tensor & result, const Tensor & self, Scalar min) {
    return infer_type(self)._th_clamp_min_out(result, self, min);
}
static inline Tensor _th_clamp_min(const Tensor & self, Scalar min) {
    return infer_type(self)._th_clamp_min(self, min);
}
static inline Tensor & _th_clamp_max_out(Tensor & result, const Tensor & self, Scalar max) {
    return infer_type(self)._th_clamp_max_out(result, self, max);
}
static inline Tensor _th_clamp_max(const Tensor & self, Scalar max) {
    return infer_type(self)._th_clamp_max(self, max);
}
static inline Tensor _dot(const Tensor & self, const Tensor & tensor) {
...
static inline Tensor & elu_out(Tensor & output, const Tensor & self, Scalar alpha, Scalar scale, Scalar input_scale) {
    return infer_type(self).elu_out(output, self, alpha, scale, input_scale);
}
static inline Tensor elu(const Tensor & self, Scalar alpha, Scalar scale, Scalar input_scale) {
    return infer_type(self).elu(self, alpha, scale, input_scale);
}
static inline Tensor & elu_forward_out(Tensor & output, const Tensor & self, Scalar alpha, Scalar scale, Scalar input_scale) {
    return infer_type(self).elu_forward_out(output, self, alpha, scale, input_scale);
}
static inline Tensor elu_forward(const Tensor & self, Scalar alpha, Scalar scale, Scalar input_scale) {
    return infer_type(self).elu_forward(self, alpha, scale, input_scale);
}
static inline Tensor & elu_backward_out(Tensor & grad_input, const Tensor & grad_output, Scalar alpha, Scalar scale, Scalar input_scale, const Tensor & output) {
    return infer_type(grad_input).elu_backward_out(grad_input, grad_output, alpha, scale, input_scale, output);
}
static inline Tensor elu_backward(const Tensor & grad_output, Scalar alpha, Scalar scale, Scalar input_scale, const Tensor & output) {
    return infer_type(grad_output).elu_backward(grad_output, alpha, scale, input_scale, output);
}
static inline Tensor & elu_(Tensor & self, Scalar alpha, Scalar scale, Scalar input_scale) {
    return infer_type(self).elu_(self, alpha, scale, input_scale);
}
static inline Tensor & elu_forward_(Tensor & self, Scalar alpha, Scalar scale, Scalar input_scale) {
    return infer_type(self).elu_forward_(self, alpha, scale, input_scale);
}
...
static inline std::tuple<Tensor,Tensor> _cudnn_ctc_loss(const Tensor & log_probs, const Tensor & targets, IntList input_lengths, IntList target_lengths, int64_t blank, bool deterministic) {
    return infer_type(log_probs)._cudnn_ctc_loss(log_probs, targets, input_lengths, target_lengths, blank, deterministic);
}
static inline Tensor _cudnn_rnn_flatten_weight(TensorList weight_arr, int64_t weight_stride0, int64_t input_size, int64_t mode, int64_t hidden_size, int64_t num_layers, bool batch_first, bool bidirectional) {
...
static inline std::tuple<Tensor,Tensor> _fused_dropout(const Tensor & self, double p, Generator * generator) {
    return infer_type(self)._fused_dropout(self, p, generator);
}
static inline Tensor _masked_scale(const Tensor & self, const Tensor & mask, double scale) {
    return infer_type(self)._masked_scale(self, mask, scale);
}
static inline Tensor dropout(const Tensor & input, double p, bool train) {
    return infer_type(input).dropout(input, p, train);
}
static inline Tensor & dropout_(Tensor & self, double p, bool train) {
    return infer_type(self).dropout_(self, p, train);
}
static inline Tensor feature_dropout(const Tensor & input, double p, bool train) {
    return infer_type(input).feature_dropout(input, p, train);
}
static inline Tensor & feature_dropout_(Tensor & self, double p, bool train) {
    return infer_type(self).feature_dropout_(self, p, train);
}
static inline Tensor alpha_dropout(const Tensor & input, double p, bool train) {
    return infer_type(input).alpha_dropout(input, p, train);
}
static inline Tensor & alpha_dropout_(Tensor & self, double p, bool train) {
    return infer_type(self).alpha_dropout_(self, p, train);
}
static inline Tensor feature_alpha_dropout(const Tensor & input, double p, bool train) {
    return infer_type(input).feature_alpha_dropout(input, p, train);
}
static inline Tensor & feature_alpha_dropout_(Tensor & self, double p, bool train) {
    return infer_type(self).feature_alpha_dropout_(self, p, train);
}
static inline Tensor abs(const Tensor & self) {
...
static inline std::vector<Tensor> broadcast_tensors(TensorList tensors) {
    return infer_type(tensors).broadcast_tensors(tensors);
}
...
static inline Tensor ctc_loss(const Tensor & log_probs, const Tensor & targets, IntList input_lengths, IntList target_lengths, int64_t blank, int64_t reduction) {
    return infer_type(log_probs).ctc_loss(log_probs, targets, input_lengths, target_lengths, blank, reduction);
}
...
static inline std::tuple<Tensor,Tensor> _ctc_loss(const Tensor & log_probs, const Tensor & targets, IntList input_lengths, IntList target_lengths, int64_t blank) {
    return infer_type(log_probs)._ctc_loss(log_probs, targets, input_lengths, target_lengths, blank);
}
static inline Tensor _ctc_loss_backward(const Tensor & grad, const Tensor & log_probs, const Tensor & targets, IntList input_lengths, IntList target_lengths, const Tensor & neg_log_likelihood, const Tensor & log_alpha, int64_t blank) {
    return infer_type(grad)._ctc_loss_backward(grad, log_probs, targets, input_lengths, target_lengths, neg_log_likelihood, log_alpha, blank);
}
static inline Tensor det(const Tensor & self) {
...
static inline Tensor grid_sampler(const Tensor & input, const Tensor & grid, int64_t interpolation_mode, int64_t padding_mode) {
    return infer_type(input).grid_sampler(input, grid, interpolation_mode, padding_mode);
}
static inline Tensor grid_sampler_2d(const Tensor & input, const Tensor & grid, int64_t interpolation_mode, int64_t padding_mode) {
    return infer_type(input).grid_sampler_2d(input, grid, interpolation_mode, padding_mode);
}
static inline std::tuple<Tensor,Tensor> grid_sampler_2d_backward(const Tensor & grad_output, const Tensor & input, const Tensor & grid, int64_t interpolation_mode, int64_t padding_mode) {
    return infer_type(grad_output).grid_sampler_2d_backward(grad_output, input, grid, interpolation_mode, padding_mode);
}
static inline Tensor grid_sampler_3d(const Tensor & input, const Tensor & grid, int64_t interpolation_mode, int64_t padding_mode) {
    return infer_type(input).grid_sampler_3d(input, grid, interpolation_mode, padding_mode);
}
static inline std::tuple<Tensor,Tensor> grid_sampler_3d_backward(const Tensor & grad_output, const Tensor & input, const Tensor & grid, int64_t interpolation_mode, int64_t padding_mode) {
    return infer_type(grad_output).grid_sampler_3d_backward(grad_output, input, grid, interpolation_mode, padding_mode);
}
static inline Tensor hann_window(int64_t window_length, const TensorOptions & options) {
    const DeviceGuard guard(options.device());
...
static inline Tensor linear(const Tensor & input, const Tensor & weight, const Tensor & bias) {
    return infer_type(input).linear(input, weight, bias);
}
static inline Tensor linspace(Scalar start, Scalar end, const TensorOptions & options) {
    const DeviceGuard guard(options.device());
...
static inline Tensor matrix_rank(const Tensor & self, double tol, bool symmetric) {
    return infer_type(self).matrix_rank(self, tol, symmetric);
}
static inline Tensor matrix_rank(const Tensor & self, bool symmetric) {
    return infer_type(self).matrix_rank(self, symmetric);
}
...
static inline std::tuple<Tensor,Tensor,Tensor> miopen_batch_norm(const Tensor & input, const Tensor & weight, const Tensor & bias, const Tensor & running_mean, const Tensor & running_var, bool training, double exponential_average_factor, double epsilon) {
    return infer_type(input).miopen_batch_norm(input, weight, bias, running_mean, running_var, training, exponential_average_factor, epsilon);
}
static inline std::tuple<Tensor,Tensor,Tensor> miopen_batch_norm_backward(const Tensor & input, const Tensor & grad_output, const Tensor & weight, const Tensor & running_mean, const Tensor & running_var, const Tensor & save_mean, const Tensor & save_var, double epsilon) {
    return infer_type(input).miopen_batch_norm_backward(input, grad_output, weight, running_mean, running_var, save_mean, save_var, epsilon);
}
static inline Tensor miopen_convolution(const Tensor & self, const Tensor & weight, const Tensor & bias, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) {
    return infer_type(self).miopen_convolution(self, weight, bias, padding, stride, dilation, groups, benchmark, deterministic);
}
static inline Tensor miopen_convolution_backward_input(IntList self_size, const Tensor & grad_output, const Tensor & weight, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) {
    return infer_type(grad_output).miopen_convolution_backward_input(self_size, grad_output, weight, padding, stride, dilation, groups, benchmark, deterministic);
}
static inline std::tuple<Tensor,Tensor,Tensor> miopen_convolution_backward(const Tensor & self, const Tensor & grad_output, const Tensor & weight, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic, std::array<bool,3> output_mask) {
    return infer_type(self).miopen_convolution_backward(self, grad_output, weight, padding, stride, dilation, groups, benchmark, deterministic, output_mask);
}
static inline Tensor miopen_convolution_backward_bias(const Tensor & grad_output) {
    return infer_type(grad_output).miopen_convolution_backward_bias(grad_output);
}
static inline Tensor miopen_convolution_backward_weight(IntList weight_size, const Tensor & grad_output, const Tensor & self, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) {
    return infer_type(self).miopen_convolution_backward_weight(weight_size, grad_output, self, padding, stride, dilation, groups, benchmark, deterministic);
}
static inline Tensor miopen_convolution_transpose(const Tensor & self, const Tensor & weight, const Tensor & bias, IntList padding, IntList output_padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) {
    return infer_type(self).miopen_convolution_transpose(self, weight, bias, padding, output_padding, stride, dilation, groups, benchmark, deterministic);
}
static inline std::tuple<Tensor,Tensor,Tensor> miopen_convolution_transpose_backward(const Tensor & self, const Tensor & grad_output, const Tensor & weight, IntList padding, IntList output_padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic, std::array<bool,3> output_mask) {
    return infer_type(self).miopen_convolution_transpose_backward(self, grad_output, weight, padding, output_padding, stride, dilation, groups, benchmark, deterministic, output_mask);
}
static inline Tensor miopen_convolution_transpose_backward_input(const Tensor & grad_output, const Tensor & weight, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) {
    return infer_type(grad_output).miopen_convolution_transpose_backward_input(grad_output, weight, padding, stride, dilation, groups, benchmark, deterministic);
}
static inline Tensor miopen_convolution_transpose_backward_weight(IntList weight_size, const Tensor & grad_output, const Tensor & self, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) {
    return infer_type(self).miopen_convolution_transpose_backward_weight(weight_size, grad_output, self, padding, stride, dilation, groups, benchmark, deterministic);
}
static inline Tensor mm(const Tensor & self, const Tensor & mat2) {
...
static inline Tensor mvlgamma(const Tensor & self, int64_t p) {
    return infer_type(self).mvlgamma(self, p);
}
static inline Tensor narrow(const Tensor & self, int64_t dim, int64_t start, int64_t length) {
...
static inline Tensor celu(const Tensor & self, Scalar alpha) {
    return infer_type(self).celu(self, alpha);
}
static inline Tensor & celu_(Tensor & self, Scalar alpha) {
    return infer_type(self).celu_(self, alpha);
}
static inline Tensor sigmoid(const Tensor & self) {
...
static inline Tensor & _sparse_add_out(Tensor & result, const Tensor & self, const Tensor & other, Scalar alpha) {
    return infer_type(self)._sparse_add_out(result, self, other, alpha);
}
static inline Tensor & _sparse_dense_add_out(Tensor & result, const Tensor & self, SparseTensorRef other, Scalar alpha) {
    return infer_type(self)._sparse_dense_add_out(result, self, other, alpha);
}
static inline Tensor & _sparse_div_zerodim_out(Tensor & result, const Tensor & self, const Tensor & other) {
    return infer_type(self)._sparse_div_zerodim_out(result, self, other);
}
static inline Tensor & _sparse_div_scalar_out(Tensor & result, const Tensor & self, Scalar other) {
    return infer_type(self)._sparse_div_scalar_out(result, self, other);
}
static inline Tensor & _sparse_mul_out(Tensor & result, const Tensor & self, const Tensor & other) {
    return infer_type(self)._sparse_mul_out(result, self, other);
}
static inline Tensor & _sparse_mul_zerodim_out(Tensor & result, const Tensor & self, const Tensor & other) {
    return infer_type(self)._sparse_mul_zerodim_out(result, self, other);
}
static inline Tensor & _sparse_mul_scalar_out(Tensor & result, const Tensor & self, Scalar other) {
    return infer_type(self)._sparse_mul_scalar_out(result, self, other);
}
...
static inline Tensor rot90(const Tensor & self, int64_t k, IntList dims) {
    return infer_type(self).rot90(self, k, dims);
}
...
static inline Scalar _local_scalar(const Tensor & self) {
    return infer_type(self)._local_scalar(self);
}
static inline Scalar _local_scalar_dense(const Tensor & self) {
    return infer_type(self)._local_scalar_dense(self);
}
static inline std::tuple<Tensor,Tensor,Tensor> _thnn_fused_lstm_cell(const Tensor & input_gates, const Tensor & hidden_gates, const Tensor & cx, const Tensor & input_bias, const Tensor & hidden_bias) {
    return infer_type(input_gates)._thnn_fused_lstm_cell(input_gates, hidden_gates, cx, input_bias, hidden_bias);
}
static inline std::tuple<Tensor,Tensor,Tensor,Tensor,Tensor> _thnn_fused_lstm_cell_backward(const Tensor & grad_hy, const Tensor & grad_cy, const Tensor & cx, const Tensor & cy, const Tensor & workspace, bool has_bias) {
    return infer_type(grad_hy)._thnn_fused_lstm_cell_backward(grad_hy, grad_cy, cx, cy, workspace, has_bias);
}
static inline std::tuple<Tensor,Tensor> _thnn_fused_gru_cell(const Tensor & input_gates, const Tensor & hidden_gates, const Tensor & hx, const Tensor & input_bias, const Tensor & hidden_bias) {
    return infer_type(input_gates)._thnn_fused_gru_cell(input_gates, hidden_gates, hx, input_bias, hidden_bias);
}
static inline std::tuple<Tensor,Tensor,Tensor,Tensor,Tensor> _thnn_fused_gru_cell_backward(const Tensor & grad_hy, const Tensor & workspace, bool has_bias) {
    return infer_type(grad_hy)._thnn_fused_gru_cell_backward(grad_hy, workspace, has_bias);
}
static inline std::tuple<Tensor,Tensor,Tensor> lstm(const Tensor & input, TensorList hx, TensorList params, bool has_biases, int64_t num_layers, double dropout, bool train, bool bidirectional, bool batch_first) {
    return infer_type(input).lstm(input, hx, params, has_biases, num_layers, dropout, train, bidirectional, batch_first);
}
static inline std::tuple<Tensor,Tensor,Tensor> lstm(const Tensor & data, const Tensor & batch_sizes, TensorList hx, TensorList params, bool has_biases, int64_t num_layers, double dropout, bool train, bool bidirectional) {
    return infer_type(data).lstm(data, batch_sizes, hx, params, has_biases, num_layers, dropout, train, bidirectional);
}
static inline std::tuple<Tensor,Tensor> gru(const Tensor & input, const Tensor & hx, TensorList params, bool has_biases, int64_t num_layers, double dropout, bool train, bool bidirectional, bool batch_first) {
    return infer_type(input).gru(input, hx, params, has_biases, num_layers, dropout, train, bidirectional, batch_first);
}
static inline std::tuple<Tensor,Tensor> gru(const Tensor & data, const Tensor & batch_sizes, const Tensor & hx, TensorList params, bool has_biases, int64_t num_layers, double dropout, bool train, bool bidirectional) {
    return infer_type(data).gru(data, batch_sizes, hx, params, has_biases, num_layers, dropout, train, bidirectional);
}
static inline std::tuple<Tensor,Tensor> rnn_tanh(const Tensor & input, const Tensor & hx, TensorList params, bool has_biases, int64_t num_layers, double dropout, bool train, bool bidirectional, bool batch_first) {
    return infer_type(input).rnn_tanh(input, hx, params, has_biases, num_layers, dropout, train, bidirectional, batch_first);
}
static inline std::tuple<Tensor,Tensor> rnn_tanh(const Tensor & data, const Tensor & batch_sizes, const Tensor & hx, TensorList params, bool has_biases, int64_t num_layers, double dropout, bool train, bool bidirectional) {
    return infer_type(data).rnn_tanh(data, batch_sizes, hx, params, has_biases, num_layers, dropout, train, bidirectional);
}
static inline std::tuple<Tensor,Tensor> rnn_relu(const Tensor & input, const Tensor & hx, TensorList params, bool has_biases, int64_t num_layers, double dropout, bool train, bool bidirectional, bool batch_first) {
    return infer_type(input).rnn_relu(input, hx, params, has_biases, num_layers, dropout, train, bidirectional, batch_first);
}
static inline std::tuple<Tensor,Tensor> rnn_relu(const Tensor & data, const Tensor & batch_sizes, const Tensor & hx, TensorList params, bool has_biases, int64_t num_layers, double dropout, bool train, bool bidirectional) {
    return infer_type(data).rnn_relu(data, batch_sizes, hx, params, has_biases, num_layers, dropout, train, bidirectional);
}
static inline std::tuple<Tensor,Tensor> lstm_cell(const Tensor & input, TensorList hx, const Tensor & w_ih, const Tensor & w_hh, const Tensor & b_ih, const Tensor & b_hh) {
    return infer_type(input).lstm_cell(input, hx, w_ih, w_hh, b_ih, b_hh);
}
static inline Tensor gru_cell(const Tensor & input, const Tensor & hx, const Tensor & w_ih, const Tensor & w_hh, const Tensor & b_ih, const Tensor & b_hh) {
    return infer_type(input).gru_cell(input, hx, w_ih, w_hh, b_ih, b_hh);
}
static inline Tensor rnn_tanh_cell(const Tensor & input, const Tensor & hx, const Tensor & w_ih, const Tensor & w_hh, const Tensor & b_ih, const Tensor & b_hh) {
    return infer_type(input).rnn_tanh_cell(input, hx, w_ih, w_hh, b_ih, b_hh);
}
static inline Tensor rnn_relu_cell(const Tensor & input, const Tensor & hx, const Tensor & w_ih, const Tensor & w_hh, const Tensor & b_ih, const Tensor & b_hh) {
    return infer_type(input).rnn_relu_cell(input, hx, w_ih, w_hh, b_ih, b_hh);
}
