...
void CAFFE2_API protobuf_AddDesc_caffe2_2fproto_2fhsm_2eproto();
...
class CAFFE2_API NodeProto : public ::google::protobuf::Message {
 public:
  NodeProto();
  virtual ~NodeProto();
 ...
 private:
  ...
  friend void CAFFE2_API protobuf_AddDesc_caffe2_2fproto_2fhsm_2eproto();
...
class CAFFE2_API TreeProto : public ::google::protobuf::Message {
 public:
  TreeProto();
  virtual ~TreeProto();
...
class CAFFE2_API HierarchyProto : public ::google::protobuf::Message {
 public:
  HierarchyProto();
...
class CAFFE2_API PathProto : public ::google::protobuf::Message {
 public:
  PathProto();
  virtual ~PathProto();
...
class CAFFE2_API PathNodeProto : public ::google::protobuf::Message {
 public:
  PathNodeProto();
