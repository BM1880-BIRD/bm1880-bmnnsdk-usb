...
class Weight : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_weight_offset() const;
  inline void clear_weight_offset();
  static const int kWeightOffsetFieldNumber = 1;
  inline ::google::protobuf::uint64 weight_offset() const;
  inline void set_weight_offset(::google::protobuf::uint64 value);

  // required uint64 weight_length = 2;
  inline bool has_weight_length() const;
  inline void clear_weight_length();
  static const int kWeightLengthFieldNumber = 2;
  inline ::google::protobuf::uint64 weight_length() const;
  inline void set_weight_length(::google::protobuf::uint64 value);

  // @@protoc_insertion_point(class_scope:bmodel.Weight)
 private:
  inline void set_has_weight_offset();
  inline void clear_has_weight_offset();
  inline void set_has_weight_length();
  inline void clear_has_weight_length();
...
class Model : public ::google::protobuf::Message {
 public:
  ...
  inline int weight_info_size() const;
  inline void clear_weight_info();
  static const int kWeightInfoFieldNumber = 10;
  inline const ::bmodel::Weight& weight_info(int index) const;
  inline ::bmodel::Weight* mutable_weight_info(int index);
  inline ::bmodel::Weight* add_weight_info();
