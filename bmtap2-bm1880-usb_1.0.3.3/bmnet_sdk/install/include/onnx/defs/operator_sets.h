...
class ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 1, LSTMUnit);
...
class OpSet_Onnx_ver1 {
 public:
  static void ForEachSchema(std::function<void(OpSchema&&)> fn) {
    ...
    fn(GetOpSchema<ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 1, LSTMUnit)>());
...
class ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 7, LSTMUnit);
...
class OpSet_Onnx_ver7 {
 public:
  static void ForEachSchema(std::function<void(OpSchema&&)> fn) {
    ...
    fn(GetOpSchema<ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 7, LSTMUnit)>());
