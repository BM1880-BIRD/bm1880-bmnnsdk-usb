...
void QuantizeConvTranspose(OnnxOperator *inst, qWeight_t *q_weight, qBias_t *q_bias,
                           NetCTable_t *net_ctable);
...
void QuantizeSigmoid(OnnxOperator *inst, qWeight_t *q_weight, qBias_t *q_bias,
                     NetCTable_t *net_ctable);
...
void QuantizePRelu(OnnxOperator *inst, qWeight_t *q_weight, qBias_t *q_bias,
                   NetCTable_t *net_ctable);

void QuantizeLeakyRelu(OnnxOperator *inst, qWeight_t *q_weight, qBias_t *q_bias,
                       NetCTable_t *net_ctable);
