#ifndef BM1880_GDMA_REG_H
#define BM1880_GDMA_REG_H
...
static inline void parse_gdma_reg(gdma_reg_t *r, const u32 *buf)
{
  r->valid = buf[0 / 4] & 1;
...
static inline void print_gdma_reg(gdma_reg_t *r)
{
  if (r == NULL)
    return;
  ...
  printf("GDMA REG:\n"
	 ...
	 r->special_function,
	 r->gmem_data_type,
	 r->winograd_scale_factor,
	 r->lrn_shift_dirction,
	 r->copy_chw,
	 r->cmd_id_bd,
	 r->const_to_fill,
	 (ulong)r->src_addr,
...
static inline void emit_gdma_reg(const gdma_reg_t *r, u32 *buf)
{
  buf[0x3c / 4] = 0;
