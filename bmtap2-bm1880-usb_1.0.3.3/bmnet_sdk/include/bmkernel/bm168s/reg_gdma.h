...
#define  GDMA_NC_TRANSPOSE             1
#define  GDMA_LRN_SHIFT                2
#define  GDMA_FORMAT_CONVERSION        3
#define  GDMA_CONSTANT                 4
#define  GDMA_CW_TRANSPOSE             5
#define  GDMA_WINOGRAD                 6

#define  GDMA_SYSTEM_DATA_NEURON       0
#define  GDMA_SYSTEM_DATA_MATRIX       1

#define  GDMA_TYPE_f32           0
#define  GDMA_TYPE_i16           1
#define  GDMA_TYPE_u8            2
#define  GDMA_TYPE_i8            3
#define  GDMA_TYPE_f16           4
#define  LAST_GDMA_TYPE          5

#define  GDMA_DIR_S2L            0
#define  GDMA_DIR_L2S            1
#define  GDMA_DIR_S2S            2
#define  GDMA_DIR_L2L            3
#define  GDMA_DIR_LAST           4

#define  LRN_LEFT_SHIFT  0
#define  LRN_RIGHT_SHIFT 1

#define  GDMA_ENGINE_DESCRIPTOR_NUM     23
#define  GDMA_REG_BYTES                 (GDMA_ENGINE_DESCRIPTOR_NUM * 4)
#define  GDMA_ENGINE_CMD_ALIGNED_BIT    6

#define  GDMA_ENGINE_MAIN_CTRL          (GDMA_ENGINE_BASE_ADDR + 0x0)
#define  GDMA_ENGINE_INT_MASK           (GDMA_ENGINE_BASE_ADDR + 0x4)
#define  GDMA_ENGINE_CMD_STATUS         (GDMA_ENGINE_BASE_ADDR + 0x8)
#define  GDMA_ENGINE_DDR_INIT           (GDMA_ENGINE_BASE_ADDR + 0xC)
