...
//#define CDMA_ENIGNE_COMMAND_NUM      9
#define CDMA_ENGINE_DESCRIPTOR_NUM    9

#define CDMA_ENIGNE_MAIN_CTRL          (CDMA_ENIGNE_BASE_ADDR + 0x800)
#define CDMA_CMD_BASE_ADDR             (CDMA_ENIGNE_BASE_ADDR + 0x00000878)
#define CDMA_MSG_BASE_ADDR             (CDMA_ENIGNE_BASE_ADDR + 0x00000928)

// HDMA is host side CDMA
// FIXME: BASE ADDRESS is allocated runtime on HOST, can do this way
#define HDMA_ENIGNE_BASE_ADDR          0
#define HDMA_ENIGNE_MAIN_CTRL          (HDMA_ENIGNE_BASE_ADDR + 0x800)
#define HDMA_CMD_BASE_ADDR             (HDMA_ENIGNE_BASE_ADDR + 0x00000878)
#define HDMA_MSG_BASE_ADDR             (HDMA_ENIGNE_BASE_ADDR + 0x00000928)
...
#define REG_BM1680_CHL_INT_STAT_RAW         0x994
...
#define BM1680_CHL_CTRL_INT_DIS                 (0x01 << 3)
...
#define BM1680_CHL_INT_CMD_STAT_UPDATED        (0x01 << 0)
#define BM1680_CHL_INT_INVALID_CMD             (0x01 << 1)
...
#define BM1680_CHL_INT_CMD_TO                  (0x01 << 28)
...
#define BM1680_CHL_INT_DMA_ERR_GROUP            BM1680_CHL_INT_INVALID_CMD  \
                                                | BM1680_CHL_INT_CMD_FIFO_OVERFLOW  \
                                                | BM1680_CHL_INT_DMA_RX_DMA_ERR  \
                                                | BM1680_CHL_INT_DMA_TX_DMA_ERR  \
                                                | BM1680_CHL_INT_CMD_TO  \
                                                | BM1680_CHL_INT_CRC0_ERR_DET  \
                                                | BM1680_CHL_INT_CRC1_ERR_DET  \
                                                | BM1680_CHL_INT_MAC0_OVF_DET  \
                                                | BM1680_CHL_INT_MAC1_OVF_DET

#define BM1680_CHL_INT_CMD_GROUP               BM1680_CHL_INT_CMD_STAT_UPDATED \
                                                | BM1680_CHL_INT_DMA_ERR_GROUP
                                                //FIXME: do not enable cmd fifo empty int for now. wait for new working flow
...
#define BM1680_CHL_INT_CMD_STAT_UPDATED_MASK   (0x01 << 0)
#define BM1680_CHL_INT_INVALID_CMD_MASK        (0x01 << 1)
...
#define CDMA_CMD_ACCP9_DEFAULT         0x0
#define CDMA_CMD_ACCP10_DEFAULT        0x0

#define CDMA_CMD_NUM                   11
...
#ifdef USING_CMODEL
/* there is no 16bit access on hardware */
/* for 16 bit access */
#define CDMA_MSG_IN_RP                 (0x08)
#define CDMA_MSG_IN_WP                 (0x0a)
#define CDMA_MSG_OUT_RP                (0x0c)
#define CDMA_MSG_OUT_WP                (0x0e)
#endif
