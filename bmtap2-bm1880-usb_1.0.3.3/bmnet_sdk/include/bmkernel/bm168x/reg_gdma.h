...
#define GDMA_ENGINE_DESCRIPTOR_NUM     15
#define GDMA_ENGINE_DESCRIPTOR_DMA_NUM 16
...
#define GDMA_ACCPI0_GDMA_CMDID_BIT     16
#define GDMA_ACCPI0_COMMON_MODE_BIT    10
#define GDMA_ACCPI0_ACCUMULATE_BIT     9
...
#define GDMA_ACCPI0_DESCRIPTOR_BIT     1
#define GDMA_ACCPI0_DESC_VALID_BIT     0

#define GDMA_ACCPI1_BD_CMDID_BIT       16
#define GDMA_ACCPI1_CHW_SHARE_BIT      14
#define GDMA_ACCPI1_LRN_BIT            9
#define GDMA_ACCPI1_MEM_TYPE_BIT       8    // 0 - Neuron, 1- Matrix
#define GDMA_ACCPI1_SRC_FMT_BIT        5
#define GDMA_ACCPI1_DST_FMT_BIT        3
#define GDMA_ACCPI1_SF_BIT             0
#define GDMA_SF_TP_VALUE               0b001
#define GDMA_SF_LRN_VALUE              0b010
#define GDMA_SF_FMT_VALUE              0b011
#define GDMA_SF_CONS_VALUE             0b100
...
#define GDMA_CMD_ACCP1_DEFAULT         ((1 << GDMA_ACCPI1_LRN_BIT) | (1 << GDMA_ACCPI1_CHW_SHARE_BIT))
...
#define GDMA_DCR_BASE_ADDR             (GDMA_ENGINE_BASE_ADDR + 0x10)
