...
class FrontendContext {
 ...
 public:
  ...
  std::vector<TensorShape> &get_net_input_shapes() { return input_shapes_; }
  TensorShape &get_bmodel_input_shape() { return input_shape_; }
  void set_net_input_shape(const std::vector<TensorShape> &shapes) { input_shapes_ = shapes; }
  void set_bmodel_input_shape(const TensorShape &shape) { input_shape_.CopyFrom(shape); }
  ...
  virtual NetParameter *convert(void *orig, std::vector<TensorShape> &input_shapes) = 0;
