...
#ifndef PROTOBUF_INCLUDED_onnx_2fonnx_2doperators_5fbmnet_5fonnx_2eproto
#define PROTOBUF_INCLUDED_onnx_2fonnx_2doperators_5fbmnet_5fonnx_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_onnx_2fonnx_2doperators_5fbmnet_5fonnx_2eproto ONNX_API

namespace protobuf_onnx_2fonnx_2doperators_5fbmnet_5fonnx_2eproto {
...
namespace google {
namespace protobuf {
template<> ONNX_API ::bmnet_onnx::FunctionProto* Arena::CreateMaybeMessage<::bmnet_onnx::FunctionProto>(Arena*);
template<> ONNX_API ::bmnet_onnx::OperatorProto* Arena::CreateMaybeMessage<::bmnet_onnx::OperatorProto>(Arena*);
template<> ONNX_API ::bmnet_onnx::OperatorSetProto* Arena::CreateMaybeMessage<::bmnet_onnx::OperatorSetProto>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace bmnet_onnx {
...
class ONNX_API FunctionProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:bmnet_onnx.FunctionProto) */ {
 public:
  FunctionProto();
  ...
  ::bmnet_onnx::OperatorStatus status() const;
  void set_status(::bmnet_onnx::OperatorStatus value);
 ...
 private:
  ...
  int status_;
  friend struct ::protobuf_onnx_2fonnx_2doperators_5fbmnet_5fonnx_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class ONNX_API OperatorProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:bmnet_onnx.OperatorProto) */ {
 public:
  OperatorProto();
...
class ONNX_API OperatorSetProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:bmnet_onnx.OperatorSetProto) */ {
 public:
  OperatorSetProto();
  ...
  ::bmnet_onnx::OperatorProto* mutable_operator_(int index);
  ::google::protobuf::RepeatedPtrField< ::bmnet_onnx::OperatorProto >*
      mutable_operator_();
  const ::bmnet_onnx::OperatorProto& operator_(int index) const;
  ::bmnet_onnx::OperatorProto* add_operator_();
  const ::google::protobuf::RepeatedPtrField< ::bmnet_onnx::OperatorProto >&
      operator_() const;
  ...
  ::bmnet_onnx::FunctionProto* mutable_functions(int index);
  ::google::protobuf::RepeatedPtrField< ::bmnet_onnx::FunctionProto >*
      mutable_functions();
  const ::bmnet_onnx::FunctionProto& functions(int index) const;
  ::bmnet_onnx::FunctionProto* add_functions();
  const ::google::protobuf::RepeatedPtrField< ::bmnet_onnx::FunctionProto >&
      functions() const;
...
inline void FunctionProto::set_name(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:bmnet_onnx.FunctionProto.name)
}
#endif
...
inline ::std::string* FunctionProto::release_name() {
  // @@protoc_insertion_point(field_release:bmnet_onnx.FunctionProto.name)
  if (!has_name()) {
    return NULL;
  }
  clear_has_name();
...
inline ::std::string* FunctionProto::add_input() {
  // @@protoc_insertion_point(field_add_mutable:bmnet_onnx.FunctionProto.input)
  return input_.Add();
}
...
inline ::std::string* FunctionProto::add_output() {
  // @@protoc_insertion_point(field_add_mutable:bmnet_onnx.FunctionProto.output)
  return output_.Add();
}
...
inline ::std::string* FunctionProto::add_attribute() {
  // @@protoc_insertion_point(field_add_mutable:bmnet_onnx.FunctionProto.attribute)
...
inline void FunctionProto::set_doc_string(::std::string&& value) {
  ...
  doc_string_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:bmnet_onnx.FunctionProto.doc_string)
}
#endif
...
inline ::std::string* FunctionProto::release_doc_string() {
  // @@protoc_insertion_point(field_release:bmnet_onnx.FunctionProto.doc_string)
  if (!has_doc_string()) {
    return NULL;
  }
  clear_has_doc_string();
...
inline void OperatorProto::set_op_type(::std::string&& value) {
  ...
  op_type_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:bmnet_onnx.OperatorProto.op_type)
}
#endif
...
inline ::std::string* OperatorProto::release_op_type() {
  // @@protoc_insertion_point(field_release:bmnet_onnx.OperatorProto.op_type)
  if (!has_op_type()) {
    return NULL;
  }
  clear_has_op_type();
...
inline void OperatorProto::set_doc_string(::std::string&& value) {
  ...
  doc_string_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:bmnet_onnx.OperatorProto.doc_string)
}
#endif
...
inline ::std::string* OperatorProto::release_doc_string() {
  // @@protoc_insertion_point(field_release:bmnet_onnx.OperatorProto.doc_string)
  if (!has_doc_string()) {
    return NULL;
  }
  clear_has_doc_string();
...
inline void OperatorSetProto::set_magic(::std::string&& value) {
  ...
  magic_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:bmnet_onnx.OperatorSetProto.magic)
}
#endif
...
inline ::std::string* OperatorSetProto::release_magic() {
  // @@protoc_insertion_point(field_release:bmnet_onnx.OperatorSetProto.magic)
  if (!has_magic()) {
    return NULL;
  }
  clear_has_magic();
...
inline void OperatorSetProto::set_ir_version_prerelease(::std::string&& value) {
  ...
  ir_version_prerelease_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:bmnet_onnx.OperatorSetProto.ir_version_prerelease)
}
#endif
...
inline ::std::string* OperatorSetProto::release_ir_version_prerelease() {
  // @@protoc_insertion_point(field_release:bmnet_onnx.OperatorSetProto.ir_version_prerelease)
...
inline void OperatorSetProto::set_ir_build_metadata(::std::string&& value) {
  ...
  ir_build_metadata_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:bmnet_onnx.OperatorSetProto.ir_build_metadata)
}
#endif
...
inline ::std::string* OperatorSetProto::release_ir_build_metadata() {
  // @@protoc_insertion_point(field_release:bmnet_onnx.OperatorSetProto.ir_build_metadata)
...
inline void OperatorSetProto::set_domain(::std::string&& value) {
  ...
  domain_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:bmnet_onnx.OperatorSetProto.domain)
}
#endif
...
inline ::std::string* OperatorSetProto::release_domain() {
  // @@protoc_insertion_point(field_release:bmnet_onnx.OperatorSetProto.domain)
  if (!has_domain()) {
    return NULL;
  }
  clear_has_domain();
...
inline void OperatorSetProto::set_doc_string(::std::string&& value) {
  ...
  doc_string_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:bmnet_onnx.OperatorSetProto.doc_string)
}
#endif
...
inline ::std::string* OperatorSetProto::release_doc_string() {
  // @@protoc_insertion_point(field_release:bmnet_onnx.OperatorSetProto.doc_string)
  if (!has_doc_string()) {
    return NULL;
  }
  clear_has_doc_string();
...
template <> struct is_proto_enum< ::bmnet_onnx::OperatorStatus> : ::std::true_type {};
template <>
...
#endif  // PROTOBUF_INCLUDED_onnx_2fonnx_2doperators_5fbmnet_5fonnx_2eproto
