...
_QUANTIZATIONCALIBRATIONPARAMETER = _descriptor.Descriptor(
  name='QuantizationCalibrationParameter',
  full_name='QuantizationCalibrationParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='right_shift_width', full_name='QuantizationCalibrationParameter.right_shift_width', index=0,
      number=1, type=5, cpp_type=1, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='threshold_x_quantized', full_name='QuantizationCalibrationParameter.threshold_x_quantized', index=1,
      number=2, type=5, cpp_type=1, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='threshold_y_quantized', full_name='QuantizationCalibrationParameter.threshold_y_quantized', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='threshold_x', full_name='QuantizationCalibrationParameter.threshold_x', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='threshold_y', full_name='QuantizationCalibrationParameter.threshold_y', index=4,
...
_LAYERCALIBRATIONPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='quantization_param', full_name='LayerCalibrationParameter.quantization_param', index=15,
...
_LAYERCALIBRATIONPARAMETER.fields_by_name['quantization_param'].message_type = _QUANTIZATIONCALIBRATIONPARAMETER
...
DESCRIPTOR.message_types_by_name['QuantizationCalibrationParameter'] = _QUANTIZATIONCALIBRATIONPARAMETER
...
QuantizationCalibrationParameter = _reflection.GeneratedProtocolMessageType('QuantizationCalibrationParameter', (_message.Message,), dict(
  DESCRIPTOR = _QUANTIZATIONCALIBRATIONPARAMETER,
  __module__ = 'bmnet.common_calibration_pb2'
  # @@protoc_insertion_point(class_scope:QuantizationCalibrationParameter)
  ))
_sym_db.RegisterMessage(QuantizationCalibrationParameter)
