...
_DETECTOUTPUTPARAMETER_CODETYPE = _descriptor.EnumDescriptor(
  name='CodeType',
  full_name='caffe.DetectOutputParameter.CodeType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_DETECTOUTPUTPARAMETER_CODETYPE)
...
_BLOBSHAPE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='data_type_size', full_name='caffe.BlobShape.data_type_size', index=1,
...
_BLOBPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='offset', full_name='caffe.BlobProto.offset', index=9,
...
_REGIONPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='softmax', full_name='caffe.RegionParameter.softmax', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='coords', full_name='caffe.RegionParameter.coords', index=2,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='background', full_name='caffe.RegionParameter.background', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='boxes_of_each_grid', full_name='caffe.RegionParameter.boxes_of_each_grid', index=5,
...
_NETPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='weight_size', full_name='caffe.NetParameter.weight_size', index=9,
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      number=711, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='shuffle_channel_param', full_name='caffe.LayerParameter.shuffle_channel_param', index=72,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='interp_param', full_name='caffe.LayerParameter.interp_param', index=73,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='multi_input_param', full_name='caffe.LayerParameter.multi_input_param', index=75,
      number=712, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='abs_param', full_name='caffe.LayerParameter.abs_param', index=76,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='yolo_param', full_name='caffe.LayerParameter.yolo_param', index=77,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='yolopost_param', full_name='caffe.LayerParameter.yolopost_param', index=78,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='reverse_param', full_name='caffe.LayerParameter.reverse_param', index=79,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='preprocess_param', full_name='caffe.LayerParameter.preprocess_param', index=80,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='custom', full_name='caffe.LayerParameter.custom', index=81,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bn_param', full_name='caffe.LayerParameter.bn_param', index=82,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pad_param', full_name='caffe.LayerParameter.pad_param', index=83,
...
_UPSAMPLEPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='stride', full_name='caffe.UpsampleParameter.stride', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='size', full_name='caffe.UpsampleParameter.size', index=1,
...
_BATCHNORMPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='inner_eps', full_name='caffe.BatchNormParameter.inner_eps', index=3,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=True,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_NMSPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='nms_threshold', full_name='caffe.NMSParameter.nms_threshold', index=0,
      number=1, type=2, cpp_type=6, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='top_k', full_name='caffe.NMSParameter.top_k', index=1,
      number=2, type=5, cpp_type=1, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='eta', full_name='caffe.NMSParameter.eta', index=2,
      number=3, type=2, cpp_type=6, label=1,
...
_DETECTOUTPUTPARAMETER = _descriptor.Descriptor(
  name='DetectOutputParameter',
  full_name='caffe.DetectOutputParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='num_classes', full_name='caffe.DetectOutputParameter.num_classes', index=0,
      number=1, type=5, cpp_type=1, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='share_location', full_name='caffe.DetectOutputParameter.share_location', index=1,
      number=2, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=True,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='background_label_id', full_name='caffe.DetectOutputParameter.background_label_id', index=2,
      number=3, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_param', full_name='caffe.DetectOutputParameter.nms_param', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='code_type', full_name='caffe.DetectOutputParameter.code_type', index=4,
      number=5, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=2,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='keep_top_k', full_name='caffe.DetectOutputParameter.keep_top_k', index=5,
      number=6, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=200,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='confidence_threshold', full_name='caffe.DetectOutputParameter.confidence_threshold', index=6,
      number=7, type=2, cpp_type=6, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='variance_encoded_in_target', full_name='caffe.DetectOutputParameter.variance_encoded_in_target', index=7,
      number=8, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[],
  enum_types=[
    _DETECTOUTPUTPARAMETER_CODETYPE,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto2',
...
_RESHAPEPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='psroi', full_name='caffe.ReshapeParameter.psroi', index=3,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='output_dim', full_name='caffe.ReshapeParameter.output_dim', index=4,
      number=5, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='group_size', full_name='caffe.ReshapeParameter.group_size', index=5,
      number=6, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='h_psroi', full_name='caffe.ReshapeParameter.h_psroi', index=6,
      number=7, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='w_psroi', full_name='caffe.ReshapeParameter.w_psroi', index=7,
...
_PSROIPOOLINGPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='h_psroi', full_name='caffe.PSROIPoolingParameter.h_psroi', index=3,
      number=4, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='w_psroi', full_name='caffe.PSROIPoolingParameter.w_psroi', index=4,
      number=5, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PROPOSALPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pre_nms_topN', full_name='caffe.ProposalParameter.pre_nms_topN', index=1,
      number=2, type=13, cpp_type=3, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='post_nms_topN', full_name='caffe.ProposalParameter.post_nms_topN', index=2,
      number=3, type=13, cpp_type=3, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_thresh', full_name='caffe.ProposalParameter.nms_thresh', index=3,
      number=4, type=2, cpp_type=6, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='min_size', full_name='caffe.ProposalParameter.min_size', index=4,
      number=5, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=16,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='base_size', full_name='caffe.ProposalParameter.base_size', index=5,
      number=6, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=16,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='version', full_name='caffe.ProposalParameter.version', index=6,
      number=7, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=2,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='scale', full_name='caffe.ProposalParameter.scale', index=7,
      number=8, type=2, cpp_type=6, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\020\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ratio', full_name='caffe.ProposalParameter.ratio', index=8,
...
_MULTIINPUTPARAMETER = _descriptor.Descriptor(
  name='MultiInputParameter',
  full_name='caffe.MultiInputParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='shape', full_name='caffe.MultiInputParameter.shape', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_YOLOPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='classes', full_name='caffe.YoloParameter.classes', index=0,
      number=1, type=5, cpp_type=1, label=1,
...
_ABSPARAMETER = _descriptor.Descriptor(
  name='AbsParameter',
  full_name='caffe.AbsParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_YOLOMASK = _descriptor.Descriptor(
  name='YoloMask',
  full_name='caffe.YoloMask',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='mask', full_name='caffe.YoloMask.mask', index=0,
...
_ANCHORS = _descriptor.Descriptor(
  name='Anchors',
  full_name='caffe.Anchors',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='anchor', full_name='caffe.Anchors.anchor', index=0,
      number=1, type=5, cpp_type=1, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_YOLOPOSTPARAMETER = _descriptor.Descriptor(
  name='YoloPostParameter',
  full_name='caffe.YoloPostParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='classes', full_name='caffe.YoloPostParameter.classes', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=80,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='netw', full_name='caffe.YoloPostParameter.netw', index=1,
      number=2, type=5, cpp_type=1, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='neth', full_name='caffe.YoloPostParameter.neth', index=2,
      number=3, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=416,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num', full_name='caffe.YoloPostParameter.num', index=3,
      number=4, type=5, cpp_type=1, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='yolomask', full_name='caffe.YoloPostParameter.yolomask', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='anchors', full_name='caffe.YoloPostParameter.anchors', index=5,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PREPROCESSPARAMETER = _descriptor.Descriptor(
  ...
  full_name='caffe.PreprocessParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='scale', full_name='caffe.PreprocessParameter.scale', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(1),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bias', full_name='caffe.PreprocessParameter.bias', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mean_value', full_name='caffe.PreprocessParameter.mean_value', index=2,
      number=3, type=2, cpp_type=6, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='u8_format', full_name='caffe.PreprocessParameter.u8_format', index=3,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='transpose', full_name='caffe.PreprocessParameter.transpose', index=4,
      number=6, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='grayscale', full_name='caffe.PreprocessParameter.grayscale', index=5,
      number=7, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='coeff', full_name='caffe.PreprocessParameter.coeff', index=6,
      number=8, type=2, cpp_type=6, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CUSTOMIZEPARAMETER = _descriptor.Descriptor(
  name='CustomizeParameter',
  full_name='caffe.CustomizeParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='caffe.CustomizeParameter.value', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAYERPARAMETER.fields_by_name['multi_input_param'].message_type = _MULTIINPUTPARAMETER
_LAYERPARAMETER.fields_by_name['abs_param'].message_type = _ABSPARAMETER
_LAYERPARAMETER.fields_by_name['yolo_param'].message_type = _YOLOPARAMETER
_LAYERPARAMETER.fields_by_name['yolopost_param'].message_type = _YOLOPOSTPARAMETER
_LAYERPARAMETER.fields_by_name['reverse_param'].message_type = _REVERSEPARAMETER
_LAYERPARAMETER.fields_by_name['preprocess_param'].message_type = _PREPROCESSPARAMETER
_LAYERPARAMETER.fields_by_name['custom'].message_type = _CUSTOMIZEPARAMETER
...
_DETECTOUTPUTPARAMETER.fields_by_name['nms_param'].message_type = _NMSPARAMETER
_DETECTOUTPUTPARAMETER.fields_by_name['code_type'].enum_type = _DETECTOUTPUTPARAMETER_CODETYPE
_DETECTOUTPUTPARAMETER_CODETYPE.containing_type = _DETECTOUTPUTPARAMETER
...
_MULTIINPUTPARAMETER.fields_by_name['shape'].message_type = _BLOBSHAPE
_YOLOPOSTPARAMETER.fields_by_name['yolomask'].message_type = _YOLOMASK
_YOLOPOSTPARAMETER.fields_by_name['anchors'].message_type = _ANCHORS
...
DESCRIPTOR.message_types_by_name['DetectOutputParameter'] = _DETECTOUTPUTPARAMETER
...
DESCRIPTOR.message_types_by_name['MultiInputParameter'] = _MULTIINPUTPARAMETER
DESCRIPTOR.message_types_by_name['YoloParameter'] = _YOLOPARAMETER
DESCRIPTOR.message_types_by_name['AbsParameter'] = _ABSPARAMETER
DESCRIPTOR.message_types_by_name['YoloMask'] = _YOLOMASK
DESCRIPTOR.message_types_by_name['Anchors'] = _ANCHORS
DESCRIPTOR.message_types_by_name['YoloPostParameter'] = _YOLOPOSTPARAMETER
...
DESCRIPTOR.message_types_by_name['CustomizeParameter'] = _CUSTOMIZEPARAMETER
...
DetectOutputParameter = _reflection.GeneratedProtocolMessageType('DetectOutputParameter', (_message.Message,), dict(
  DESCRIPTOR = _DETECTOUTPUTPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.DetectOutputParameter)
  ))
_sym_db.RegisterMessage(DetectOutputParameter)
...
MultiInputParameter = _reflection.GeneratedProtocolMessageType('MultiInputParameter', (_message.Message,), dict(
  DESCRIPTOR = _MULTIINPUTPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.MultiInputParameter)
  ))
_sym_db.RegisterMessage(MultiInputParameter)
...
AbsParameter = _reflection.GeneratedProtocolMessageType('AbsParameter', (_message.Message,), dict(
  DESCRIPTOR = _ABSPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.AbsParameter)
  ))
_sym_db.RegisterMessage(AbsParameter)

YoloMask = _reflection.GeneratedProtocolMessageType('YoloMask', (_message.Message,), dict(
  DESCRIPTOR = _YOLOMASK,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.YoloMask)
  ))
_sym_db.RegisterMessage(YoloMask)

Anchors = _reflection.GeneratedProtocolMessageType('Anchors', (_message.Message,), dict(
  DESCRIPTOR = _ANCHORS,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.Anchors)
  ))
_sym_db.RegisterMessage(Anchors)

YoloPostParameter = _reflection.GeneratedProtocolMessageType('YoloPostParameter', (_message.Message,), dict(
  DESCRIPTOR = _YOLOPOSTPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.YoloPostParameter)
  ))
_sym_db.RegisterMessage(YoloPostParameter)
...
PreprocessParameter = _reflection.GeneratedProtocolMessageType('PreprocessParameter', (_message.Message,), dict(
  ...
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.PreprocessParameter)
  ))
...
CustomizeParameter = _reflection.GeneratedProtocolMessageType('CustomizeParameter', (_message.Message,), dict(
  DESCRIPTOR = _CUSTOMIZEPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.CustomizeParameter)
  ))
_sym_db.RegisterMessage(CustomizeParameter)
...
_PROPOSALPARAMETER.fields_by_name['scale']._options = None
_PROPOSALPARAMETER.fields_by_name['ratio']._options = None
_YOLOMASK.fields_by_name['mask']._options = None
_ANCHORS.fields_by_name['anchor']._options = None
_PADPARAMETER.fields_by_name['pads']._options = None
