...
void LeakyReluOp::quantize(qWeight_t *qWeight, qBias_t *qBias, NetCTable_t *NetCTable) {
...
OnnxOperator *LeakyReluOp::makeOp(const ONNX_NAMESPACE::Node *node) {
  return new LeakyReluOp(ctx_, node);
}
